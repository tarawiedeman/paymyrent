  ...
  return (
        ...
        <section className="login">
            ...
            <form className="login__form" onSubmit={handleSubmit}>
                ...
                <input className="login__form--input" type="text" placeholder="name@email.com" name="email"></input>

                <label className="login__form--label">Password</label>
                <input className="login__form--input" type="password" name="password"></input>
